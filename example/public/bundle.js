...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libSearch = __webpack_require__(1);
	
	var _libSearch2 = _interopRequireDefault(_libSearch);
	  ...
	  _createClass(TestComponent, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_libSearch2['default'], { items: this.props.items, placeHolder: 'Search for a programming language', onChange: this.myFunc })
	      );
	    }
	  }], [{
	    key: 'propTypes',
	...
	_reactDom2['default'].render(_react2['default'].createElement(TestComponent, { items: ITEMS }), document.getElementById('root'));
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      ...
	      var items = this.state.matchingItems.map(function (item, i) {
	        return _react2['default'].createElement('li', { key: i, className: _this.props.className + '__menu-item' }, _react2['default'].createElement('a', { onClick: _this.selectAutoComplete.bind(_this) }, item));
	      });
	
	      return _react2['default'].createElement('div', { className: this.props.className }, _react2['default'].createElement('input', { type: 'text',
	        className: inputClassName,
	        placeholder: this.props.placeHolder,
	        ref: 'searchInput',
	        onKeyUp: this.changeInput.bind(this) }), _react2['default'].createElement('div', { className: menuClassName, ref: 'autocomplete' }, _react2['default'].createElement('ul', { className: this.props.className + '__menu-items' }, items)));
	    }
	  }], [{
	    key: 'defaultProps',
	    value: {
