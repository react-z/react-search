...
var Search = function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function renderMenuItems() {
      ...
      var searchKey = _props.searchKey;
      ...
      var items = menuItems.map(function (item, i) {
        if (_this8.itemSelected(item.id)) {
          ...
          return _react2.default.createElement(
            'li',
            { key: i, className: 'autocomplete__item', onClick: _this8.handleSelect.bind(_this8) },
            _react2.default.createElement('span', { key: i, 'data-id': item.id, dangerouslySetInnerHTML: { __html: item.value } })
          );
        }
      });
    ...
    value: function renderSelectedItems() {
      ...
      var items = selectedItems.map(function (item, i) {
        var icon = _react2.default.createElement('span', { className: 'autocomplete__dropdown' });
        ...
        return _react2.default.createElement(
          ...
          { key: i, className: itemClass,
            onClick: _this9.handleItemClick.bind(_this9) },
    ...
    value: function getMenuClass() {
      ...
      var max_selected = _props3.max_selected;
